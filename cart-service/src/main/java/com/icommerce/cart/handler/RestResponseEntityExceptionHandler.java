...
public class RestResponseEntityExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<?> handleBadRequestException(IllegalProductException e) {
        LOG.error("handleBadRequestException :" + e.getMessage());
        LOG.error("handleBadRequestException :", e);
        Throwable throwable = new Throwable("Bad Request Exception :" + e.getMessage());
    ...
    public ResponseEntity<?> handleServiceUnavailableException(ServiceUnavailableException e) {
        LOG.error("handleServiceUnavailableException :" + e.getMessage());
